package com.next.demo.film.example.alipay.trade;
...
import com.next.demo.film.example.alipay.trade.model.builder.*;
import com.next.demo.film.example.alipay.trade.model.hb.*;
import com.next.demo.film.example.alipay.trade.model.result.AlipayF2FPayResult;
import com.next.demo.film.example.alipay.trade.model.result.AlipayF2FPrecreateResult;
import com.next.demo.film.example.alipay.trade.model.result.AlipayF2FQueryResult;
import com.next.demo.film.example.alipay.trade.model.result.AlipayF2FRefundResult;
import com.next.demo.film.example.alipay.trade.service.AlipayMonitorService;
...
import com.next.demo.film.example.alipay.trade.service.impl.AlipayTradeWithHBServiceImpl;
import com.next.demo.film.example.alipay.trade.utils.Utils;
...
public class Main {
    ...
    public void test_trade_query() {
        ...
        String outTradeNo = "tradeprecreate1576168829183904645";
    ...
    public void test_trade_precreate() {
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                // 需要修改为运行机器上的路径
                String filePath = String.format("D:/ChromeCoreDownloads/nextfilm/qrcode/qr-%s.png",
