package com.next.demo.film.generator;
...
public class EntityGenerator {
    ...
    private String outputDir = "H:\\workSpaceIdea\\next_film\\src\\main\\java";
    // 生成类的作者
    private String author = "Levi";
    // 数据源相关配置
    ...
    // DAO的包路径
    private String daoPackage = "com.next.demo.film.dao";
    // 待生成的表名，注意是覆盖更新
