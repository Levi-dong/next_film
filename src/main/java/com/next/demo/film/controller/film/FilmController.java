...
import com.next.demo.film.service.film.FilmServiceAPI;
...
public class FilmController {
    ...
    public BaseResponseVO getConditionList(
        ...
        // 检查入参
        catId = filmServiceAPI.checkCondition(catId,FilmEnum.cat);
        sourceId = filmServiceAPI.checkCondition(sourceId,FilmEnum.source);
        yearId = filmServiceAPI.checkCondition(yearId,FilmEnum.year);
